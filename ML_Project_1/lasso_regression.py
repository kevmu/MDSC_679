...
lasso_regression.py - Executes LASSO Regression (L1 Regularization) on a encoded genotypes file as input.
...
# Usage example
# python lasso_regression.py --encoded_genotypes_infile /Users/kevin.muirhead/Desktop/GWAS_OUTPUT_DIR_bonf_corr_value/PARSED_GENOTYPES_OUTPUT_DIR/encoded_genotypes.tsv --output_dir /Users/kevin.muirhead/Desktop/GWAS_OUTPUT_DIR_bonf_corr_value/PARSED_GENOTYPES_OUTPUT_DIR/LASSO_REGRESSION_METRICS_OUTPUT_DIR

parser = argparse.ArgumentParser(description='Perform LASSO Regression (L1 Regularization) on a encoded genotypes file as input.' )
...
# The output file.
outfile = os.path.join(output_dir, "_".join([filename, "lasso_regression_metrics.tsv"]))
...
metrics_outfile = os.path.join(output_dir, "_".join([filename, "lasso_regression_metrics.tsv"]))
...
# The Lasso Regression (L1 Regularization) model.
...
print('Train accuracy of LASSO Regression: {:0.2f}%.'.format(mape_train_accuracy))
...
print('Test accuracy of LASSO Regression: {:0.2f}%.'.format(mape_test_accuracy))
